...
public class AlbumServiceImpl implements AlbumServiceInterface {
        ...
        @Override
        public org.springframework.data.domain.Page<AlbumDTO> getAlbumsByArtistPaginated(Long artistId,
                        org.springframework.data.domain.Pageable pageable) {
                return albumRepository.findByArtist_ArtistId(artistId, pageable)
                                .map(albumMapper::toDTO);
        }
        ...
        @Override
        public void incrementPlayCount(Long albumId) {
                Album album = albumRepository.findById(albumId)
                                .orElseThrow(() -> new RuntimeException("Album not found"));
